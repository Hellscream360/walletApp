        ...
        <div className="container mx-auto px-4 pt-32 pb-20">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-6xl font-bold mb-8 leading-tight bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-emerald-400">
              Visualisez et Maîtrisez vos Investissements
            </h1>
            <p className="text-xl text-gray-300 mb-8">
              Une vision claire et intuitive de votre portefeuille financier pour des décisions d'investissement éclairées
            </p>
