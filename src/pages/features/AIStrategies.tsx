            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-300">
                  Utilisez des modèles d'IA avancés pour analyser les tendances
                  du marché et prédire les mouvements de prix potentiels.
                </p>
              </div>
              <div>
                ...
                <p className="text-gray-300">
                  Laissez l'IA optimiser votre allocation d'actifs en fonction
                  de vos objectifs et de votre tolérance au risque.
                </p>
              </div>
              <div>
                <h3 className="text-2xl font-bold mb-4">
                ...
                <p className="text-gray-300">
                  Recevez des alertes personnalisées basées sur l'analyse en
                  temps réel des conditions du marché et de votre portefeuille.
                </p>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-2xl p-8 text-center">
            ...
            <p className="text-xl text-gray-200 mb-6">
              Commencez dès maintenant à utiliser l'intelligence artificielle
